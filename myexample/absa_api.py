...
if __name__ == '__main__':
    ...
    export_data(hostname=hostnames[0], dirpath="/opt/lavector/absa/", jsonfile='7081-0707-5000.json')
    export_data(hostname=hostnames[1], dirpath="/opt/lavector/absa/", jsonfile='7082-0707-5000.json')
    export_data(hostname=hostnames[2], dirpath="/opt/lavector/absa/", jsonfile='7083-0707-5000.json')
    export_data(hostname=hostnames[3], dirpath="/opt/lavector/absa/", jsonfile='7084-0707-5000.json')
