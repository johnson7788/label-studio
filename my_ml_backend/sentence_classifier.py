...
class SentenceClassifier(LabelStudioMLBase):
    ...
    def __init__(self, **kwargs):
        ...
        super(SentenceClassifier, self).__init__(**kwargs)

        self.train_url = "http://192.168.50.139:5016/api/train_truncate"
        # self.train_url = "http://127.0.0.1:5000/api/train_truncate"
        self.predict_url = "http://192.168.50.139:5016/api/predict_truncate"
