...
class PurchaseTextClassifier(LabelStudioMLBase):
    ...
    def __init__(self, **kwargs):
        ...
        super(PurchaseTextClassifier, self).__init__(**kwargs)

        # self.train_url = "http://192.168.50.117:5016/api/train_truncate"
        self.train_url = "http://192.168.50.189:5016/api/train_truncate"
        # self.predict_url = "http://192.168.50.117:5016/api/predict_truncate"
        self.predict_url = "http://192.168.50.189:5016/api/predict_truncate"
