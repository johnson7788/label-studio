...
class ComponentsTextClassifier(LabelStudioMLBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.train_url = "http://192.168.50.189:3326/api/dem8_predict"
        # self.train_url = "http://127.0.0.1:5000/api/train_truncate"
        self.predict_url = "http://192.168.50.189:3326/api/dem8_predict"
    ...
    def predict(self, tasks, **kwargs):
        ...
        for task in tasks:
            one_data = (task['data'][self.value], task['data']['keyword'], task['data']['wordtype'])
