...
from relation_classifier import RelationExtract
...
if __name__ == "__main__":
    ...
    if args.check:
        print('Check "' + RelationExtract.__name__ + '" instance creation..')
        model = RelationExtract(**kwargs)

    app = init_app(
        model_class=RelationExtract,
