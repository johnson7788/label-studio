...
from object_detection_classifier import YOLODetection
...
if __name__ == "__main__":
    ...
    if args.check:
        print('Check "' + YOLODetection.__name__ + '" instance creation..')
        model = YOLODetection(**kwargs)

    app = init_app(
        model_class=YOLODetection,
